                        ...
                        <div class="sign-user_card ">
                            <div class="sign-in-page-data">
                                <div class="sign-in-from w-100 m-auto" >
                                    <h3 class="mb-3 text-center" style="font-family: Cairo">{{__("reg.payment method")}}</h3>
...
{{--                                    </form>--}}
{{--                                   <div class="{{__("reg.float")}}">--}}
{{--                                       <img src="{{asset("images/myfatoorah.png")}}" alt="My Fatoorah" width="30%" height="30%">--}}
...
{{--                                   </div>--}}
                            ...
                            <div class="mt-3">
                                <div class="d-flex justify-content-center links" >
                                    <a href="{{$url}}" class="text-center" style="font-family: Cairo">
                                        <img src="{{asset("images/myfatoorah.png")}}" width="30%" alt="myFatoorah" class="rounded">
                                        <h4>ماي فاتورة</h4>
                                    </a>
                                    <br>
                                    <h3></h3>

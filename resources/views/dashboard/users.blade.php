                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title" >
                                <h4 class="card-title" style="font-family: Cairo">{{__("dashboard.users list")}}</h4>
                            </div>
                            @can("viewAdd" , \App\Models\User::class)
                                <div class="iq-card-header-toolbar d-flex align-items-center" style="font-family: Cairo">
                                    <a href="{{route("dashboard.users.add")}}" class="btn btn-primary">{{__("dashboard.add new user")}}</a>
                                </div>
                            @endcan
                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <table class="data-tables table movie_table dataTable no-footer" style="width: 100%;" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th style="width: 39px;" class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending">{{__("dashboard.name")}}</th>
                                                    <th style="width: 69px;" class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Contact: activate to sort column ascending">{{__("dashboard.phone")}}</th>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="flex align-items-center list-user-action">
                                                                @can("update" , $user)
                                                                <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{__("dashboard.edit")}}" href="/dashboard/users/edit/{{$user->id}}"><i class="ri-pencil-line"></i></a>
                                                                @endcan
                                                                @can("delete" , $user)
                                                                    <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{__("dashboard.delete")}}" href="/dashboard/users/delete/{{$user->id}}"><i class="ri-delete-bin-line"></i></a>
                                                                @endcan
                                                            </div>
                                                        </td>
                                                    </tr>

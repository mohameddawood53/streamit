                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title" >
                                <h4 class="card-title" style="font-family: Cairo">{{__("dashboard.edit user")}}</h4>
                            </div>
                        </div>
                        <div class="iq-card-body" style="font-family: Cairo">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="/dashboard/users/update/{{$user->id}}" method="post" id="my-form">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control @error("name") is-invalid @enderror" value="{{$user->name}}" placeholder="{{__("reg.full name")}}" style="font-family: Cairo;background-color: #191919; border: 1px solid #404043">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            <input type="email" style="font-family: Cairo;background-color: #191919; border: 1px solid #404043" name="email" class="form-control @error("email") is-invalid @enderror" value="{{empty(old("email")) ? $user->email: old("email")}}" placeholder="{{__("reg.email")}}">
                                            @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="phone" style="font-family: Cairo;background-color: #191919; border: 1px solid #404043" class="form-control @error("phone") is-invalid @enderror" value="{{empty(old("phone")) ? $user->phone : old("phone")}}" placeholder="{{__("reg.phone")}}">
                                            @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg @error("package") is-invalid @enderror"  style="font-family: Cairo;background-color: #191919; border: 1px solid #404043" name="package">
                                                ...
                                                @if($user->package == "1")
                                                    selected
                                                @endif
                                                >{{__("reg.yearly bundle")}}</option>
                                                <option value="2"
                                                        @if($user->package == "2")
                                                        selected
                                                    @endif
                                                >{{__("reg.3 month bundle")}}</option>
                                                <option value="3"
                                                        @if($user->package == "3")
                                                        selected
                                                    @endif
                                                >{{__("reg.monthly bundle")}}</option>
                                            </select>
                                            @error('package')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg @error("lang") is-invalid @enderror" style="background-color: #191919; border: 1px solid #404043" name="lang" required>
                                                ...
                                                <option value="ar" @if($user->lang == "ar") selected @endif>العربية</option>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <a href="/dashboard/users" class="btn btn-danger">{{__("dashboard.back")}}</a>
{{--                                            <button type="reset" class="btn btn-danger">{{__("dashboard.reset")}}</button>--}}
    ...
    @push("scripts")
        ...
        {!! JsValidator::formRequest('App\Http\Requests\editUser', '#my-form'); !!}
    @endpush
@endsection

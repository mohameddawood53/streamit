...
@section("content")
    <div class="iq-sidebar" style="font-family: Cairo">
        <div class="iq-sidebar-logo d-flex justify-content-between">
            <a href="/dashboard" class="header-logo">
                <img src="{{asset("images/2.png")}}" class="img-fluid rounded-normal" alt="">
                <div class="logo-title">
                    <span class="text-primary text-uppercase" style="font-weight: bolder; font-size: larger">Streamit</span>
                </div>
            </a>
        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    <li><a href="/" class="text-primary" style="font-family: Cairo"><i class="fas fa-long-arrow-alt-right"></i><span> {{__("dashboard.visit website")}}</span></a></li>
                    <li class="{{request()->routeIs("home") ? "active active-menu" : ""}}"><a href="/dashboard" class="iq-waves-effect"><i class="fas fa-home"></i><span>{{__("dashboard.dashboard")}}</span></a></li>
{{--                    <li><a href="rating.html" class="iq-waves-effect"><i class="fas fa-star-half-alt"></i><span>Rating </span></a></li>--}}
{{--                    <li><a href="comment.html" class="iq-waves-effect"><i class="fas fa-comments"></i><span>Comment</span></a></li>--}}
{{--                    <li class="{{request()->routeIs("dashboard.users") ? "active active-menu" : ""}}"><a href="/dashboard/users" class="iq-waves-effect"><i class="fas fa-user-friends"></i><span>{{__("dashboard.users")}}</span></a></li>--}}
                    <li>
                        <a href="#users" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="{{request()->routeIs("dashboard.users*")  ? "true" : "false"}}"><i class="fas fa-user-friends"></i><span>{{__("dashboard.users")}}</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="users" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            @can("viewAdd" , \App\Models\User::class)
                                <li class="{{request()->routeIs("dashboard.users.add") ? "active active-menu" : ""}}"><a href="{{route("dashboard.users.add")}}"><i class="fas fa-user-plus"></i>{{__("dashboard.add new user")}}</a></li>
                            @endcan
                            <li class="{{request()->routeIs("dashboard.users") ? "active active-menu" : ""}}"><a href="/dashboard/users"><i class="fas fa-user-friends"></i>{{__("dashboard.users list")}}</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#category" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="{{request()->routeIs("categories*")  ? "true" : "false"}}"><i class="fas fa-list-ul"></i><span>{{__("dashboard.categories")}}</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="{{request()->routeIs("categories.index") ? "active active-menu" : ""}}"><a href="{{route("categories.index")}}"><i class="fas fa-user-plus"></i>{{__("dashboard.cat list")}}</a></li>
                            <li class="{{request()->routeIs("categories.add") ? "active active-menu" : ""}}"><a href="{{route("categories.add")}}"><i class="fas fa-eye"></i>{{__("dashboard.add category")}}</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#movie" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="fas fa-film"></i><span>Movie</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="movie" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="add-movie.html"><i class="fas fa-user-plus"></i>Add Movie</a></li>
                            <li><a href="movie-list.html"><i class="fas fa-eye"></i>Movie List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#movie" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="{{request()->routeIs("language*")  ? "true" : "false"}}"><i class="fas fa-globe"></i><span>{{__("dashboard.langs")}}</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="movie" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="{{request()->routeIs("language.add") ? "active active-menu" : ""}}"><a href="{{route("language.add")}}"><i class="fas fa-language"></i>{{__("dashboard.add lang")}}</a></li>
                            <li class="{{request()->routeIs("language.index") ? "active active-menu" : ""}}"><a href="{{route("language.index")}}"><i class="fas fa-globe"></i>{{__("dashboard.lang list")}}</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#show" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                                class="fas fa-film"></i><span>Show</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i>
                        </a>
                        <ul id="show" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="add-show.html"><i class="fas fa-user-plus"></i>Add Show</a></li>
                            <li><a href="show-list.html"><i class="fas fa-eye"></i>Show List</a></li>
                        </ul>
                    </li>
                    <li><a href="pages-pricing.html" class="iq-waves-effect"><i class="ri-price-tag-line"></i><span>Pricing</span></a></li>
                    <li>
                        <a href="#ui-elements" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="fab fa-elementor iq-arrow-left"></i><span>UI Elements</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    ...
                    <li>
                        <a href="#pages" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="fas fa-file-alt iq-arrow-left"></i><span>Pages</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
        ...
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"  aria-label="Toggle navigation">
                    <i class="ri-menu-3-line" style="content: '\eded'"></i>
                </button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li class="nav-item nav-icon">
                            <input type="hidden" value="{{auth()->id()}}" id="user_id_not">
                            <a href="#" class="search-toggle iq-waves-effect text-gray rounded">
                                <i class="ri-notification-2-line"></i>
{{--                                <span class="bg-primary dots" v-if="notifications > 0"></span>--}}
                                <span class="bg-primary dots" v-if="notifications.length > 0"></span>
                                ...
                                <div class="iq-card shadow-none m-0">
                                    <div class="iq-card-body p-0">
                                        <div class="bg-primary p-3">
                                            <h5 class="mb-0 text-white" style="font-family: Cairo">{{__("dashboard.all notifications")}}<small class="badge  badge-light float-right pt-1">@{{notifications.length }}</small></h5>
                                        </div>
                                        <a href="#" class="iq-sub-card" v-if="notifications.length > 0">
                                            <div class="media align-items-center" v-for="noti in notifications" v-bind:id="noti.id">
                                                <div class="">
                                                    <img class="avatar-40 rounded" src="../assets/images/user/01.jpg" alt="">
                                                </div>
                                                <div class="media-body ml-3">
                                                    <h6 class="mb-0 " v-if="noti.user.lang === 'ar'">@{{ noti.message.ar }}</h6>
                                                    <h6 class="mb-0 " v-if="noti.user.lang === 'en'">@{{ noti.message.en }}</h6>
                                        ...
                                        @else
                                            <div class="p-3" v-if="notifications.length == 0">
                                               {{__("dashboard.there is not notification")}}
                                            </div>
                                        @endif
{{--                                        <a href="#" class="iq-sub-card" >--}}
{{--                                            <div class="media align-items-center">--}}
...
{{--                                        </a>--}}
                        ...
                        <li class="line-height pt-3">
                            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                <img src="@if(auth()->user()->img) {{asset("storage/" . auth()->user()->img)}} @else {{asset("images/user/user.jpg")}} @endif" class="img-fluid rounded-circle mr-3" alt="user">
                            </a>
                            <div class="iq-sub-dropdown iq-user-dropdown">
                                <div class="iq-card shadow-none m-0">
                                    <div class="iq-card-body p-0 " >
                                        <div class="bg-primary p-3">
                                            <h5 class="mb-0 text-white line-height" style="font-family: Cairo" > {{__("dashboard.hello") . " " . auth()->user()->name}}</h5>
                                            <span class="text-white font-size-12" style="font-family: Cairo;">{{__("dashboard.available")}}</span>
                                        </div>

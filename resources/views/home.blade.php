                                        ...
                                        <div class="iq-card-body p-0">
                                            <div class="iq-thumb">
                                                <a href="javascript:void(0)">
                                                    <img src="https://templates.iqonic.design/streamit/dashboard/html/assets/images/dashboard/01.jpg" class="img-fluid w-100 img-border-radius" alt="">
                                                </a>
                                            </div>
                                            <div class="iq-feature-list">
                                                ...
                                                <div class="d-flex align-items-center my-2">
                                                    <p class="mb-0 mr-2"><i class="far fa-eye mr-1"></i> 134</p>
                                                    <p class="mb-0 "><i class="fas fa-download ml-2"></i> 30 k</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

...
return [
    ...
    'custom'               => [
        ...
        'lang' => [
            ...
            'not_in' => 'يجب أختيار أحد اللغات',

        ],
        'phone' => [
            "regex" => "رقم الموبايل غير صحيح"
        ],
        'password' => [
            "regex" => "كلمة السر ضعيفة. يجب أن تحتوي علي الاقل علي 1 من الأحرف الكبيرة و1 من الأحرف الصغيرة ورقم"
        ],
        'name' => [
            "regex" => "من فضلك ادخل اسمك الحقيقي"
        ],
